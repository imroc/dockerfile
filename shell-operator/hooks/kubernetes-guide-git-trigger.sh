...
EOF
  ...
  tkn task start mdbook-build-push -n -p tekton-pipelines srcRepo="https://github.com/imroc/kubernetes-guide.git" -p destRepo="https://gitee.com/imroc/kubernetes-guide-book.git"
fi